...
my $res;
$res = Thruk::Utils::XS::socket_pool_do(10, ["/tmp/live6.sock", "GET status", "/tmp/live6.sock", "GET timeperiods"]);
...
$res = Thruk::Utils::XS::socket_pool_do(10, ["/tmp/live6.sock", "GET status"]);
